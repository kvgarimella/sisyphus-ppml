...
parser = argparse.ArgumentParser(description='PyTorch CIFAR10 QuaIL+AMM Training')
...
if args.model == "alexnet_bn":
    ...
    import mobilenetv1
    student = mobilenetv1.MobileNetV1(num_classes=10)
    student = student.to(device)
    teacher = mobilenetv1.MobileNetV1(num_classes=10)
    teacher = teacher.to(device)
    num_layers = 28
...
os.system("mkdir -p approx_quail_nets_cifar10")
torch.save(student.state_dict(), "approx_quail_nets_cifar10/{}_{}_stage1.pth".format(args.model, args.approxmode))
...
test(args, student, device, testloader, epoch)
torch.save(student.state_dict(), "approx_quail_nets_cifar10/{}_{}_stage2.pth".format(args.model, args.approxmode))
wandb.save("approx_quail_nets_cifar10/{}_{}_stage1.pth".format(args.model, args.approxmode))
wandb.save("approx_quail_nets_cifar10/{}_{}_stage2.pth".format(args.model, args.approxmode))
