...
parser = argparse.ArgumentParser(description='PyTorch CIFAR10 Baseline Training')
...
for epoch in range(start_epoch, start_epoch+args.epochs):
    ...
    scheduler.step()
os.system("mkdir -p cifar10")
torch.save(net.state_dict(), "cifar10/" + ckpt_name)
wandb.save("cifar10/" + ckpt_name)
