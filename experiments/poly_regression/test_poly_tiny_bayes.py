...
parser = argparse.ArgumentParser(description='PyTorch TinyImageNet Poly Regression Test Function')
...
for i in range(NUM_RANDOM):
    ...
    net.module.change_all_activations(ReLUPolyApprox(R=curr_R, order=curr_order))
...
net.module.change_all_activations(ReLUPolyApprox(R=best_R, order=best_order))
...
os.system("mkdir -p bayes_data_tiny")
torch.save(train_x, "bayes_data_tiny/xs_{}.pth".format(args.model))
torch.save(train_obj, "bayes_data_tiny/ys_{}.pth".format(args.model))
