...
parser = argparse.ArgumentParser(description='PyTorch CIFAR10 QuaIL Training')
...
os.system("mkdir -p quail_nets_cifar10")
torch.save(student.state_dict(), "quail_nets_cifar10/{}_stage1.pth".format(args.model))
...
test(args, student, device, testloader, epoch)
torch.save(student.state_dict(), "quail_nets_cifar10/{}_stage2.pth".format(args.model))
